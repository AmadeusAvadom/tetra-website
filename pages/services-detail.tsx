                        ...
                        <div className="relative items-center py-14 lg:flex lg:py-[100px]">
                            <div className="relative z-[1] text-center text-white lg:w-3/5 ltr:lg:text-left rtl:lg:text-right xl:w-3/5">
                                ...
                                <p className="my-8 text-xl leading-[40px] text-[#7780A1]">
                                    El equipo de Tetra maneja el ciclo completo de servicios de diseño de sitios web y aplicaciones móviles. Producimos solo aplicaciones y sitios web de primer nivel con un excelente diseño de UX, UI, navegación y funcionalidad..
                                </p>
            ...
            <section className="py-14 lg:py-[100px]">
                <div className="container">
                    <div className="heading text-center lg:w-7/12 ltr:lg:text-left rtl:lg:text-right">
                        <h6>Proceso de diseño</h6>
                        <h4>Mantenga a sus usuarios en el centro de su proceso de diseño con nuestras prácticas UXD</h4>
                        <p className="mt-4 text-lg font-semibold">
                            Combinamos la amplia experiencia de nuestro equipo en diseño, el conocimiento íntimo de nuestros clientes de las industrias a las que sirven y sus conocimientos.
                        </p>
                    </div>
                    {/*
                ...
                <div className="container">
                    <div className="relative z-10 lg:flex">
                        <div className="heading text-center rtl:pl-10 lg:mb-0 lg:w-1/3 ltr:lg:pr-10 ltr:lg:text-left rtl:lg:text-right">
                            ...
                            <h4 className="sm:!leading-[50px]">¿Listo para empezar?</h4>
                            <img
                        ...
                        <form action="" className="rounded-3xl bg-white px-4 py-12 dark:bg-[#101626] lg:w-2/3 lg:px-8">
                            <div className="grid gap-10 sm:grid-cols-2">
                                <div className="relative">
                                    ...
                                    <UserIcon width={20} height={22} className='absolute top-1/2 -translate-y-1/2 ltr:right-4 rtl:left-4 dark:text-white' />
                                </div>
                                <div className="relative">
                                    <input
                                        type="email"
                                    ...
                                    <MailIcon width={22} height={21} className='absolute top-1/2 -translate-y-1/2 ltr:right-4 rtl:left-4 dark:text-white' />
                                </div>
                                <div className="relative">
                                    <input
                                        type="text"
                                    ...
                                    <PhoneIcon width={22} height={22} className="absolute top-1/2 -translate-y-1/2 ltr:right-4 rtl:left-4 dark:text-white" />
                                </div>
                                <div className="relative">
                                    <input
                                        type="text"
                                    ...
                                    <LocationIcon width={20} height={22} className="absolute top-1/2 -translate-y-1/2 ltr:right-4 rtl:left-4 dark:text-white" />
                                </div>
                            </div>
                            <div className="relative mt-10">
                                ...
                                <ChatIcon width={22} height={22} className="absolute top-1/2 -translate-y-1/2 ltr:right-4 rtl:left-4 dark:text-white" />
                            </div>
                            <div className="mt-10 text-center ltr:lg:text-right rtl:lg:text-left">
                                <button type="button" className="btn bg-gray px-12 capitalize text-white dark:bg-white dark:text-black dark:hover:bg-secondary" onClick={sendEmailForm}>
                                    Enviar Mensaje
                                </button>
                            </div>
                        </form>
